...
> 
> ✨ **Novidades Recentes (Ciclo 49):** Reestruturação Completa Mobile-First do Painel da Oficina / Auto Center (`oficina.app`). Desenvolvido com foco no mecânico e funcionário operando diretamente pelo smartphone via cards grandes de toque ágil (*Abriu → Identificou → Clicou → Executou → Voltou*), sem sidebars ou tabelas truncadas. Dashboard com 6 cards principais (Entrada de Veículos, Lançar Serviços sem preços, Clientes, Notas Fiscais, Enviar Fotos com câmera/galeria e Buscar Veículos) e cards individuais verticais abaixo (Manutenção dos Veículos, Avisos com WhatsApp automático inteligente, Relatórios, Financeiro, Estoque e Configurações). Alternador interativo para Modo Web para telas grandes. 45 testes automatizados aprovados com 100% de sucesso.
